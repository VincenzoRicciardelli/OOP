...
public class TestClass {
	public static void main(String[] args) throws TrailException, InterruptedException {
        ...
        int n3 = trail.newRunner("Vincenzo", "Ricciardelli");
        int n4 = trail.newRunner("Rino", "Caputo");
        ...
        trail.assignDelegate("Valgrisanche", "MRIRSS65B10A413B");
        
        trail.recordPassage("MRIRSS65B10A413B", "Courmayeur", n4);
        Thread.sleep(4150);
        trail.recordPassage("MRIRSS65B10A413B", "La Thuile", n3);
        Thread.sleep(100);
        trail.recordPassage("MRIRSS65B10A413B", "La Thuile", n1);
        Thread.sleep(4900);
        trail.recordPassage("MRIRSS65B10A413B", "Valgrisanche", n2);
		
        List<Runner> rank = trail.getRanking("La Thuile");
        ...
        List<Runner> rankTot = trail.getRanking();
        System.out.println("Ranking:");
        int posiz=1;
        for(Runner r : rankTot){
            System.out.println(posiz++ + "\t" + r.getSurname() + " " + r.getName() + " (" + r.getBibNumber() + ")");
        }
	}	
}
